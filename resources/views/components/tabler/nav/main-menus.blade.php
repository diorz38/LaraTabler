...
<li class="nav-item {{ request()->is('*layout*') ? 'active' : ''}} dropdown">
    ...
    <div class="dropdown-menu">
        <div class="dropdown-menu-columns">
            <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is('*horizontal') ? 'active' : ''}}" href="{{ route('layout.tabler.horizontal') }}">
                    Horizontal
                </a>
                {{-- <a class="dropdown-item {{ request()->is('*vertical-transparent') ? 'active' : ''}}" href="{{ route('layout.tabler.vertical-transparent') }}">
                    Vertical transparent
                </a>
                <a class="dropdown-item" href="./layout-vertical-right.html">
                    Right vertical
                </a> --}}
                <a class="dropdown-item {{ request()->is('*condensed') ? 'active' : ''}}" href="{{ route('layout.tabler.condensed') }}">
                    Condensed
                </a>
                <a class="dropdown-item {{ request()->is('*condensed-dark') ? 'active' : ''}}" href="{{ route('layout.tabler.condensed-dark') }}">
                    Condensed dark
                </a>
                <a class="dropdown-item {{ request()->is('*combo') ? 'active' : ''}}" href="{{ route('layout.tabler.combo') }}">
                    Combined
                </a>
            </div>
            <div class="dropdown-menu-column">
                ...
                <a class="dropdown-item {{ request()->is('*sticky') ? 'active' : ''}}" href="{{ route('layout.tabler.sticky') }}">
                    Navbar sticky
                </a>
