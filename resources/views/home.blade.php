    ...
    <div class="container-xl">
        <div class="alert alert-warning alert-dismissible" role="alert">
            <div class="d-flex">
                ...
                <div>
                    <h4 class="alert-title">Ada sesuatu yang salah!!</h4>
            ...
            <div class="row row-deck row-cards">
                            ...
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="w-1">
                                            <span class="avatar avatar-sm"
                                                style="background-image: url({{ asset('static/avatars/001f.jpg') }})"></span>
                                        </td>
                                        <td class="td-truncate">
                                            <div class="text-truncate">
                            ...
                            <div class="divide-y">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/002f.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/003f.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/006m.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/009m.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/010m.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/005f.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                style="background-image: url({{ asset('static/avatars/006f.jpg') }})"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank"
                        rel="noopener" style="background-image: url({{ asset('static/sponsor-banner-homepage.svg') }})"
