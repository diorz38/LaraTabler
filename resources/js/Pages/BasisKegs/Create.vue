<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      <Link class="text-indigo-400 hover:text-indigo-600" :href="route('amake.basiskegs.index')">BasisKegs</Link>
...
export default {
  metaInfo: { title: 'Create BasisKeg' },
  layout: Layout,
  remember: 'form',
  data() {
    return {
  ...
  methods: {
    store() {
      this.form.post(this.route('basiskegs.store'))
    },
  },
}
</script>
