              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group mb-3 row">
                    ...
                    <div class="col">
                      <select class="form-select" v-model="form.seksi_id" disabled>
                  ...
                  <div class="form-group mb-3 row">
                    ...
                    <div class="col">
                      <select class="form-select" v-model="form.bidang_id" disabled >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col">
                      <label class="form-check">
                        <input type="radio" id="one" value="1" v-model="form.is_active" disabled>
                        <label for="one">Aktif</label>
                        <br>
                        <input type="radio" id="two" value="0" v-model="form.is_active" disabled>
                  ...
                  <div class="form-footer">
                    <Link :href="route('amake.basiskegs.edit', form.id)" class="btn btn-primary">EDIT</Link>
                  </div>
                </form>
              </div>
            </div>
